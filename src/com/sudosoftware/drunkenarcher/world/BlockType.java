...
public enum BlockType {
	...
	DIRT((byte)1, new float[]{1.0f, 0.0f}, new float[]{1.0f, 0.0f}, new float[]{1.0f, 0.0f}),
	GRASS((byte)2, new float[]{2.0f, 0.0f}, new float[]{2.0f, 1.0f}, new float[]{1.0f, 0.0f}),
	STONE((byte)3, new float[]{3.0f, 0.0f}, new float[]{3.0f, 0.0f}, new float[]{3.0f, 0.0f});
